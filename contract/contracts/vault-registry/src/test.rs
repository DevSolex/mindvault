...
impl LifecycleOp {
    ...
    fn from_byte(byte: u8) -> Self {
        match byte % 7 {
            0 => LifecycleOp::Relist,
            1 => LifecycleOp::Delist,
            2 => LifecycleOp::Freeze,
            3 => LifecycleOp::OpenDispute,
            4 => LifecycleOp::Resolve(ResourceState::Listed),
            5 => LifecycleOp::Resolve(ResourceState::Delisted),
            _ => LifecycleOp::Resolve(ResourceState::Frozen),
        }
    }
}
